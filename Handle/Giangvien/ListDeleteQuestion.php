...
session_start();
   if(isset($_SESSION['email'])){
       ...
       $sql = "select * from xoacauhoi where MaGiangVien='$maGiangVien'";
        ...
        <div class="row">
            ...
            <table class=table name='hocphan'>
                ...
                <?php while ($row = mysqli_fetch_array($result)) {
                    ...
                    <td>
                        <form method='post' action='UndoQuestion.php'>
                            <input type="hidden" name ="txtCodeQuestion" value="<?php echo $row['MaCH']?>">
                         <input type="submit" value="Trở lại ngân hàng đề" name="btnUndo" class="btn btn-primary">
